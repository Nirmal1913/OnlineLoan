...
<div class="">
	...
	<a href="AddCategory.jsp" class="button">Add Category</a>	
			  <center>
...
%>
				  ...
				  <td><%=resultSet.getString("cName") %></td>
				   ...
				   <td><a href="UpdateCategory.jsp?id=<%=resultSet.getInt("id") %>"><button class="button3" data-title="Edit" data-toggle="modal" data-target="#edit" ><span class="fas fa-trash-alt"></span></button></p></a></td>
				 
				  <td><a href="DeleteCategory.jsp?id=<%=resultSet.getInt("id") %>"><button class="button2" data-title="Delete" data-toggle="modal" data-target="#delete" ><span class="fas fa-trash-alt"></span></button></p></a></td>
