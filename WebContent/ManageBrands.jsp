...
<div class="">
	...
	<a href="AddBrands.jsp" class="button">Add Brand</a>	
			  <center>
...
%>
				  ...
				  <td><%=resultSet.getString("bDate") %></td>
				   ...
				   <td><a href="UpdateBrands.jsp?id=<%=resultSet.getInt("id") %>"><button class="button3" data-title="Edit" data-toggle="modal" data-target="#edit" ><span class="fas fa-trash-alt"></span></button></p></a></td>
				 
				  <td><a href="DeleteBrand.jsp?id=<%=resultSet.getInt("id") %>"><button class="button2" data-title="Delete" data-toggle="modal" data-target="#delete" ><span class="fas fa-trash-alt"></span></button></p></a></td>
